...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/jquery-mask-plugin/dist/jquery.mask.min.js',
            ...
            'src/main/webapp/bower_components/angular-toastr/dist/angular-toastr.tpls.min.js',
            // endbower
